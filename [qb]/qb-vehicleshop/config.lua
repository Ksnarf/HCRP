...
Config.Shops = {
    ...
    ['larryrv'] = {
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(1218.00, 2698.39, 38.00, 180.00), -- where the vehicle will spawn on display
            ...
            [2] = {
                coords = vector4(1220.00, 2698.39, 38.00, 180.00),
                defaultVehicle = 'issio',
                chosenVehicle = 'issio'
            },
            [3] = {
                coords = vector4(1222.00, 2698.39, 38.00, 180.00),
                defaultVehicle = '69charger',
                chosenVehicle = '69charger'
            },
        },
    },
    ['milheli'] = {
        ...
        ['ReturnLocation'] = vector3(-44.74, -1082.58, 26.68), -- Location to return vehicle, only enables if the vehicleshop has a job owned
        ['VehicleSpawn'] = vector4(-1859.00, 2795.00, 30.00, 330.00), -- Spawn location when vehicle is bought
        ['TestDriveSpawn'] = vector4(-1877.00, 2804.00, 30.00, 330.00), -- Spawn location for test drive
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(-2150.00, 3260.00, 31.50, 240.00), -- where the vehicle will spawn on display
            ...
            [2] = {
                ...
                chosenVehicle = 'mh65c', -- Same as default but is dynamically changed when swapping vehicles
            },
        },
    },
    ['boats'] = {
