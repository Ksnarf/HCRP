...
Config.NotifyShowTime    = 5000                -- All notification display time on screen (5000 is 5 secs)
...
Config.treatCost         = 5500                -- The treat costs (change if needed)
Config.spawnRadius       = 100                 -- Not active yet

Config.Ped = {
    ['ambulance'] = {
        company          = "American Medical Response",      -- The Company name used for sending mails
        name             = "Paramedic Sarah Conner",    -- The name of the docter using for sending mail
